...
الخطوط: `IBM Plex Sans Arabic` للنصوص و`Cairo` للعناوين، مستضافان ذاتياً عبر `next/font`
فلا طلب خارجي ولا انزلاق تخطيط.
...
| لوحة المختص | شريط سفلي بأربعة عناصر + لوحة «المزيد»، لا شريط جانبي مصغّر |
