    ...
    <div className="flex min-h-screen items-center justify-center bg-canvas p-4">
      <div className="w-full max-w-md">
        <Link href="/" className="mb-6 flex items-center justify-center gap-2.5">
          ...
          <span className="text-xl font-extrabold text-slate-900">بوصلتي</span>
        </Link>

        <div className="card p-6 sm:p-8">
          <h1 className="text-xl font-extrabold text-slate-900">تسجيل دخول المختصين</h1>
          <p className="mt-1.5 text-sm text-[var(--color-muted)]">
            هذه الصفحة مخصّصة لمختصي التوجيه المهني وإدارة المنصة. الطلاب لا يحتاجون
            حساباً لاستخدام خدمات بوصلتي.
          </p>
        ...
        <p className="mt-6 text-center text-sm">
          <Link href="/" className="text-[var(--color-muted)] transition-colors hover:text-brand-700">
            العودة إلى بوصلتي
          </Link>
        </p>
      </div>
