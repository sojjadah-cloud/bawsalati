...
// أيقونة عائمة تفتح صفحة جويب. أُخرجت من قائمة التنقّل لأنها مساعد
// يُطلب عند الحاجة في أي صفحة، لا قسماً من أقسام المنصة.
import Link from "next/link";
import { usePathname } from "next/navigation";
import { MessageCircleQuestion } from "lucide-react";

/** صفحات تُخفى فيها الأيقونة: صفحة جويب نفسها، وشاشة الاختبار ذات الشريط السفلي. */
const HIDDEN_ON = ["/ask", "/assessment/questions"];

export function JawibLauncher() {
  ...
  return (
    <Link
      href="/ask"
      aria-label="جويب: اسأل مساعد المنصة"
    ...
    >
      ...
      <span className="hidden text-base font-bold sm:inline">جويب</span>
    </Link>
  );
}
